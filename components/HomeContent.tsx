  ...
  return (
    <main>
      <section className="relative min-h-[calc(100vh-80px)] flex flex-col justify-center overflow-hidden border-b border-gothic-border/60 px-5 pb-20 pt-14 sm:px-6 sm:pb-24 sm:pt-20">
        <div className="absolute inset-0 bg-gradient-to-br from-gothic-dark via-[#071612] to-[#07241c]" aria-hidden="true" />
        <div
          className="animate-blob absolute -left-20 top-10 h-64 w-64 rounded-full bg-gothic-emerald/10 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="animate-blob absolute -right-16 bottom-0 h-72 w-72 rounded-full bg-gothic-teal/5 blur-3xl"
        ...
        <div className="relative mx-auto flex flex-col items-center justify-center max-w-[1000px] text-center w-full">
          ...
          <div
            id="hero-logo-slot"
            className="relative mb-6 h-40 w-40 sm:h-52 sm:w-52 md:h-64 md:w-64 lg:h-72 lg:w-72 filter drop-shadow-[0_0_20px_rgba(16,185,129,0.2)]"
          >
            <Image
              src="/logo.png"
              alt="ToAllTool Logo"
          ...
          >
            ...
            >
              ToAll<span className="text-gothic-emerald drop-shadow-[0_0_15px_#10b981]">Tool</span>
            </span>
          </div>

          {/* Rest of Hero Details */}
          <div className="mt-4 w-full animate-slide-up max-w-[700px] px-4">
            <p className="font-display mb-4 inline-block rounded-full border border-gothic-border/60 bg-gothic-card/70 px-4 py-1.5 text-xs font-bold text-gothic-accent backdrop-blur-sm sm:text-sm tracking-wider uppercase shadow-[0_0_15px_rgba(16,185,129,0.1)]">
            ...
            <div className="mx-auto mt-8 max-w-xl text-left">
              ...
              <div className="group flex items-center gap-3 rounded-2xl border border-gothic-border/60 bg-gothic-card/85 p-2 shadow-2xl shadow-black/85 backdrop-blur-md transition-all duration-300 focus-within:scale-[1.02] focus-within:border-gothic-emerald/80 focus-within:shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                <span className="ml-3 text-xl filter drop-shadow-[0_0_5px_rgba(16,185,129,0.5)]" aria-hidden="true">
                  🔍
                </span>
                <input
                  id="tool-search"
                ...
                {query && (
                  <button
                    type="button"
                    onClick={() => setQuery("")}
                    className="mr-2 rounded-full bg-slate-800 px-3 py-1.5 text-sm font-bold text-slate-300 transition hover:scale-110 hover:bg-gothic-emerald hover:text-white"
      ...
      <section className="mx-auto max-w-[1200px] px-5 py-16 sm:px-6 sm:py-20">
        <div className="mb-10 flex flex-col gap-2 sm:mb-12">
          <p className="text-sm font-bold uppercase tracking-widest text-gothic-emerald drop-shadow-[0_0_5px_rgba(16,185,129,0.3)]">Browse the archives</p>
          <h2 className="font-display text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            What tools shall we <span className="text-gothic-emerald filter drop-shadow-[0_0_8px_rgba(16,185,129,0.4)]">summon</span> today?
          </h2>
        </div>
