...
export default function ScrollBrand() {
  ...
  return (
    <>
      ...
      >
        <span className="whitespace-nowrap font-extrabold tracking-tight text-white drop-shadow-[0_0_15px_rgba(139,92,246,0.5)] select-none text-[60px] sm:text-[100px] md:text-[150px] lg:text-[200px] leading-none">
          ToAll<span className="text-[#8b5cf6] filter drop-shadow-[0_0_8px_#ec4899]">Tool</span>
        </span>
      </div>
    </>
  );
